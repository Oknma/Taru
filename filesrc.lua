...
function CheckQuest() 
    ...
    if World1 then
        ...
        elseif MyLevel == 450 or MyLevel <= 474 then
            ...
            NameQuest = "SkyExp1Quest"
            NameMon = "Shanda"
            CFrameQuest = CFramenew(-7859.09814, 5544.19043, -381.476196, -0.422592998, 0, 0.906319618, 0, 1, 0, -0.906319618, 0, -0.422592998)
...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>taruhub chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "taruhub", HidePremium = false, IntroText = "taruhub⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("taruhub SCRIPT")
W:AddLabel("Discordtaruhub")
local Section = W:AddSection({
    Name = "Status"
})
